...
class QuestionnairesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post questionnaires_url, params: { questionnaire: { noQuestion: @questionnaire.noQuestion, subject: @questionnaire.subject } }
    end
  ...
  test "should update questionnaire" do
    patch questionnaire_url(@questionnaire), params: { questionnaire: { noQuestion: @questionnaire.noQuestion, subject: @questionnaire.subject } }
